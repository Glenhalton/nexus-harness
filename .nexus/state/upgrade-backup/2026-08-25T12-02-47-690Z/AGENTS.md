# @Deepseek Ai/Dsh Root — Claude Code / Claude Cowork Instructions

> Auto-generated by [NEXUS CLI](https://github.com/GDA-Africa/nexus-cli) v1.5.1.
...
6. **Validate after changes** — `npx tsc --noEmit && pnpm test && pnpm lint`
...
`06_test_strategy.md`, and run `npx tsc --noEmit && pnpm test && pnpm lint`. Keep the plan
...
*Generated by [NEXUS CLI](https://github.com/GDA-Africa/nexus-cli) v1.5.1*
